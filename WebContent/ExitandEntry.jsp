  ...
  <li>
    ...
    <header>
        <div class="header-content">
            ...
            <font size="16">Graph having 2 Exit and 2 Entry Nodes</font><br><br>
            
          <p>
 <%! @SuppressWarnings("unchecked") %>
 <% 
List<String> graphname=new ArrayList<String>();
graphname=(List<String>)request.getAttribute("graph");
for(String graph:graphname){
	out.print("Exit and Entry nodes : "+graph);
	out.print(" ");
