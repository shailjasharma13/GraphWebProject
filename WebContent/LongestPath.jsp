  ...
  <li>
    ...
    <header>
        <div class="header-content">
            ...
            <font size="16">Longest Path of a Graph</font><br><br>
...
<input type="submit" class="btn btn-primary btn-lg" value="Get Longest Path">
...
if(success!=null){
	...
	for(String node:nodeName){
		if(i==0){
		out.println("Length :" +node +"<br>");
		}
		out.println("Longest Path :" +node+"<br>");
		i++;
		}
}%>
</p>
