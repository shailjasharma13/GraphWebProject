...
/**
 * Servlet implementation class PipelineNodes
 */
@WebServlet("/PipelineNodes")
public class PipelineNodes extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PipelineNodes() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view=request.getRequestDispatcher("PipeLineNodes.jsp");
	    view.forward(request,response);
	    System.out.println("dispatched");
	    }
		if(graphName!=null)
		{
		nodeNameList=getForkJoinNodes.getPipeLineNodes(graphName);
