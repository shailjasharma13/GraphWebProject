...
/**
 * Servlet implementation class CheckForkandJoinNodes
 */
@WebServlet("/CheckForkandJoinNodes")
public class CheckForkandJoinNodes extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckForkandJoinNodes() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view=request.getRequestDispatcher("CheckForkandJoinNodes.jsp");
	    view.forward(request,response);
	    System.out.println("dispatched");
	    }
		if(graphName!=null)
		{
		nodeNameList=getForkJoinNodes.ForkJoinNodes(graphName);
